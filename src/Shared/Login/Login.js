...
const Login = () => {
    ...
    return (
<div>
<div className='grid justify-center bg-indigo-900 py-5 login'>
<div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-gray-300 text-gray-900">
	<h1 className="text-2xl font-bold text-center">Login</h1>
	<form onSubmit={handleSubmit} novalidate="" action="" className="space-y-6 ng-untouched ng-pristine ng-valid">
		<div className="space-y-1 text-sm">
			<label for="username" className="block text-gray-900">Email</label>
		...
		<button className="block w-full p-3 text-center rounded-sm text-gray-900 dark:bg-violet-400">Sign in</button>
	</form>
	...
	<p className="text-xs text-center sm:px-6 text-gray-700">Don't have an account?
		<Link rel="noopener noreferrer" to={'/register'} className="underline text-gray-700 font-bold ">Sign up</Link>
	</p>
</div>
</div>
</div>
